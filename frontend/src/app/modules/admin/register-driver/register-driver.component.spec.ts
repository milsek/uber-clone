...
describe('RegisterDriverComponent', () => {
  ...
  const driverServiceSpy = jasmine.createSpyObj<DriverService>(['register']);
  ...
  /*
    ...
    it("should display email required message", fakeAsync( () => {
      driverServiceSpy.register.calls.reset();
      const app = fixture.componentInstance;
      ...
      expect(driverServiceSpy.register).not.toHaveBeenCalled();
    }));
    ...
    it("should call register", fakeAsync( () => {
      ...
      app.registerForm.controls.confirmPassword.setValue("qweqweqwe");
      app.registerForm.controls.confirmPassword.markAsTouched();
      app.registerForm.controls.make.setValue("123");
      app.registerForm.controls.make.markAsTouched();
      app.registerForm.controls.model.setValue("123");
      app.registerForm.controls.model.markAsTouched();
      app.registerForm.controls.colour.setValue("123");
      app.registerForm.controls.colour.markAsTouched();
      app.registerForm.controls.licensePlateNumber.setValue("123");
      app.registerForm.controls.licensePlateNumber.markAsTouched();
      ...
      expect(driverServiceSpy.register).toHaveBeenCalled();
    }));
