...
public class IntegrationUtils {
    ...
    public static BasicRideCreationDTO getValidBasicRideCreationDto() {
        ...
        dto.setStartAddress("Example starting address 1, Novi Sad");
        dto.setDestinationAddress("Example destination address 1, Novi Sad");
        ...
        coordinatesDto1.setLat(45.245749);
        coordinatesDto1.setLng(19.851122);
        CoordinatesCreationDTO coordinatesDto2 = new CoordinatesCreationDTO();
        coordinatesDto2.setLat(45.252782);
        coordinatesDto2.setLng(19.855517);
        CoordinatesCreationDTO waypointsDto1 = new CoordinatesCreationDTO();
        waypointsDto1.setLat(45.245749);
        waypointsDto1.setLng(19.851122);
        CoordinatesCreationDTO waypointsDto2 = new CoordinatesCreationDTO();
        waypointsDto2.setLat(45.252782);
        waypointsDto2.setLng(19.855517);
